...
policy = baac.BetaAdvantageActorCritic(create_policy_model_beta(), create_value_model(), 2, entropy_factor=0.003, gamma=0.9, lr=0.001, lambd=0.95, value_loss_scale=0.3)
