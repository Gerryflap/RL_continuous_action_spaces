...
policy_1 = spowe.SimplePolicyOptimizerWithEntropy(model1, 2, entropy_factor=0.003, gamma=0.9, lr=0.001)
policy_2 = spowe.SimplePolicyOptimizerWithEntropy(model2, 2, entropy_factor=0.001, gamma=0.9, lr=0.001)
